...
<xsl:variable name="current_page_title" select="concat(/root/site/@title,' - ',key('label','homepage')/@tr)"/>
...
<!-- ###############################
     TRADUZIONI
     ############################### -->
<xsl:template name="translationsPck">
<xsl:variable name="f" select="/root/features/feature[@id='11']"/>
<xsl:if test="$f">
<div class="pckbox">
...
<div class="pckbox">
<xsl:variable name="f" select="/root/features/feature[@id='5']"/>
<h3 class="feature"><xsl:value-of select="$f/@name"/></h3>
<ul class="items">
<xsl:apply-templates select="$f/items" mode="fulllist"/>
</ul>
...
<!-- ###############################
     NEWS PCK ORIG
     ############################### -->
<xsl:template name="newsPckOrig">
<div class="pckbox">
<xsl:variable name="f" select="/root/features/feature[@id='45']"/>
<h3 class="feature"><xsl:value-of select="$f/@name"/></h3>
<ul class="items">
<xsl:apply-templates select="$f/items" mode="fulllist"/>
</ul>
...
<!-- ###############################
     NEWS PCK NODI
     ############################### -->
<xsl:template name="newsPckNodi">
<div class="pckbox">
<xsl:variable name="f" select="/root/features/feature[@id='107']"/>
<h3 class="feature"><xsl:value-of select="$f/@name"/></h3>
<ul class="items">
...
<!-- ###############################
     WIDGET HOME CONTENT
     ############################### -->
<xsl:template name="widgetHomeContent">
<p>Benvenuto alla homepage personalizzabile di PeaceLink</p>
</xsl:template>
