...
<div id="banda-bianca"><xsl:call-template name="graphic"><xsl:with-param name="id" select="288"/></xsl:call-template></div>
...
<xsl:apply-templates select="/root/c_features/feature[@id='137']" />
</xsl:template>
...
<xsl:apply-templates select="/root/features/feature[@id='138']" />
</div>
<div id="content-banner-right"><xsl:apply-templates select="/root/features/feature[@id='136']" />
<div class="leggi">
<xsl:for-each select="/root/features/feature[@id=136]">
<xsl:call-template name="createLink">
<xsl:with-param name="name"><xsl:text>leggi tutto</xsl:text></xsl:with-param>
...
<xsl:call-template name="bannerGroup"><xsl:with-param name="id" select="'24'"/></xsl:call-template>
<xsl:call-template name="bannerGroup"><xsl:with-param name="id" select="'23'"/></xsl:call-template>
</xsl:template>
